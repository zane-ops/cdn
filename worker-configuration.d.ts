/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 907d0be2764110b84638c06aba55ee0f)
...
type= interface TraceItemScheduledEventInfo {
    readonly scheduledTime: number;
    readonly cron: string;
}
...
type=  * An email message that can be sent from a Worker.
 */
...
decltypee 'cl= oexport type RpcStub<T extends Rpc.Stubable> = Rpc.Stub<T>;
